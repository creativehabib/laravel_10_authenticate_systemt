    ...
    <section class="flex-1 xl:mt-20">
        <div class="flex max-w-screen-lg mx-auto my-16 overflow-hidden bg-white rounded-lg lg:space-x-8 dark:bg-gray-900 lg:w-xl">
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <p class="mt-2 text-xl text-center text-gray-600 dark:text-gray-200">Join Talwind Components community</p>
                ...
                <form action="{{route('register')}}" method="post">
                    ...
                    <div class="mt-4">
                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">E-Mail Address</label>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" name="password_confirmation" class="w-full px-4 py-2 text-gray-700 bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-300 dark:focus:border-gray-200 focus:outline-none focus:ring focus:ring-slate-400 dark:placeholder-gray-400 focus:ring-opacity-20" placeholder="Enter confiram password">
                    </div>

                    <div class="mt-8">
                        <button type="submit" class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform rounded-md bg-sky-400 hover:bg-sky-600 focus:outline-none focus:bg-sky-600">Register</button>
                    </div>
                </form>

                <div class="flex items-center justify-between mt-4">
                    <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
                    <a href="/" class="text-sm text-gray-500 uppercase dark:text-gray-400 hover:underline">do you have an account?</a>
                    <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
                </div>
            </div>
        </div>
